...
| Option | Type | Default | Description |
|--------|------|---------|-------------|
| `holiday_resolver` | `class-string|null` | `YasumiHolidayResolver::class` | Resolver for holiday checks. Enabled by default via Yasumi. Set to `null` to disable holiday targeting. |
